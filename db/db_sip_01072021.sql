...
CREATE TABLE `ms_berkas`  (
  ...
  `no_su` varchar(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL,
  `thn_su` varchar(10) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL,
  `no_di_307` varchar(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL,
  `thn_di_307` varchar(10) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL,
...
-- ----------------------------
INSERT INTO `ms_berkas` VALUES (1, '001.0621', 2020, 6, 4, 1, 1, 120, '  ', '  110  ', 'Batal', 'Dikirim ke kordinator pemetaan', '1', '2021-06-30', '1', '2021-06-30', '001/ST/2021', '2021-06-02', '2021-06-01', NULL, 'Kordinator Pemetaan', 17, '2021-06-05', '2021-06-08', NULL, NULL, NULL, NULL);
INSERT INTO `ms_berkas` VALUES (2, '002.0621', 2021, 8, 2, 6, 32, 221, ' ', '  456 ', 'Selesai', 'Selesai', '1', '2021-06-30', '1', '2021-06-30', '456712', '2021-06-07', '2021-06-06', NULL, 'DP 307', 30, '2021-06-22', '2021-06-25', '001/06/2021', '2021', '001/06/DI/2021', '2019');
INSERT INTO `ms_berkas` VALUES (3, '003.0621', 2011, 6, 5, 21, 110, 312, '', '  323', 'Selesai', 'Selesai', '1', '2021-06-30', NULL, '2021-06-30', '122342', '2021-06-02', '2021-06-01', NULL, 'DP 307', 19, '2021-06-23', '2021-06-25', '002/06/2021', '2020', '002/06/DI/2021', '2018');
INSERT INTO `ms_berkas` VALUES (4, '004.0721', 2019, 8, 3, 4, 24, 123, '', '  54543', 'Selesai', 'diselesaikan DP 307', '1', '2021-07-01', NULL, '2021-07-01', '343435', '2021-07-12', '2021-07-01', NULL, 'DP 307', 19, '2021-07-30', '2021-07-31', '021/SU/07/21', '2020', '009/DI/07/21', '2021');
...
INSERT INTO `trx_history` VALUES (35, 4, 9, 'Kirim ke petugas ukur', '1', '2021-07-01 08:40:46', 'Dikirim', '-', NULL, NULL, 'Operator', NULL);
INSERT INTO `trx_history` VALUES (36, 4, 32, 'Diterima petugas ukur, dikirim ke petugas grafis', '1', '2021-07-01 08:41:35', 'Dikirim', '2 Hari', '2021-07-12', '2021-07-14', 'Petugas Ukur', NULL);
INSERT INTO `trx_history` VALUES (37, 4, 26, 'Dikirim ke petugas textual', '1', '2021-07-01 09:16:26', 'Dikirim', '1 Hari', '2021-07-15', '2021-07-16', 'Petugas Grafis', NULL);
INSERT INTO `trx_history` VALUES (38, 4, 26, 'Dikembalikan ke petugas grafis', '1', '2021-07-01 09:17:24', 'Dikembalikan', '-', NULL, NULL, 'Petugas Textual', '2021-07-16');
INSERT INTO `trx_history` VALUES (39, 4, 26, 'Dikirim ke kordinator pemetaan', '1', '2021-07-01 09:18:36', 'Dikirim', '1 Hari', '2021-07-16', '2021-07-17', 'Petugas Grafis', NULL);
INSERT INTO `trx_history` VALUES (40, 4, 29, 'Dikirim ke kordinator pemetaan', '1', '2021-07-01 09:48:06', 'Dikirim', '2 Hari', '2021-07-18', '2021-07-20', 'Petugas Textual', NULL);
INSERT INTO `trx_history` VALUES (41, 4, 18, 'Dikirim ke kordinator pengukuran', '1', '2021-07-01 09:48:44', 'Dikirim', '1 Hari', '2021-07-20', '2021-07-21', 'Kordinator Pemetaan', NULL);
INSERT INTO `trx_history` VALUES (42, 4, 18, 'dikembalikan ke kordinator pemetaan', '1', '2021-07-01 09:49:15', 'Dikembalikan', '-', NULL, NULL, 'Kordinator Pengukuran', '2021-07-21');
INSERT INTO `trx_history` VALUES (43, 4, 17, 'kirim ke kordinator pengukuran', '1', '2021-07-01 09:54:46', 'Dikirim', '2 Hari', '2021-07-21', '2021-07-23', 'Kordinator Pemetaan', NULL);
INSERT INTO `trx_history` VALUES (44, 4, 17, 'dikirim ke kasubsi', '1', '2021-07-01 09:56:55', 'Dikirim', '3 Hari', '2021-07-23', '2021-07-26', 'Kordinator Pengukuran', NULL);
INSERT INTO `trx_history` VALUES (45, 4, 13, 'dikirim ke kasi', '1', '2021-07-01 09:58:52', 'Dikirim', '1 Hari', '2021-07-26', '2021-07-27', 'Kasubsi', NULL);
INSERT INTO `trx_history` VALUES (46, 4, 12, 'diselesaikan kasi', '1', '2021-07-01 10:00:07', 'Dikirim', '3 Hari', '2021-07-27', '2021-07-30', 'Kasi', NULL);
INSERT INTO `trx_history` VALUES (47, 4, 19, 'diselesaikan DP 307', '1', '2021-07-01 10:00:42', 'Selesai', '1 Hari', '2021-07-30', '2021-07-31', 'DP 307', NULL);
