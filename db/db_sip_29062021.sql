...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 29, 2021 at 03:35 PM
...
INSERT INTO `ms_berkas` (`id_berkas`, `no_berkas`, `tahun_berkas`, `id_pemohon`, `id_layanan`, `id_kecamatan`, `id_kelurahan`, `volume`, `di_305`, `di_302`, `status_berkas`, `keterangan_berkas`, `createdBy`, `createdTime`, `updatedBy`, `updatedTime`, `no_surtug`, `tgl_mulai_surtug`, `tgl_terbit_surtug`, `id_petugas_ukur`, `posisi_berkas`, `id_pegawai`, `tgl_awal`, `tgl_akhir`) VALUES
(1, '1212', 2021, 6, 3, 1, 3, 3131, '  23443 ', '  3434 ', 'Dibuat', 'kirim ke kordinator pemetaan', '1', '2021-06-28', '1', '2021-06-28', '345343', '2021-06-22', '2021-06-23', NULL, 'Kordinator Pemetaan', 14, '2021-06-28', '2021-06-30');
...
CREATE TABLE `trx_history` (
  ...
  `lama_berkas` varchar(50) DEFAULT NULL,
...
INSERT INTO `trx_history` (`id_history`, `id_berkas`, `id_pegawai`, `catatan`, `createdBy`, `createdTime`, `status`, `lama_berkas`, `tgl_mulai`, `tgl_selesai`, `posisi`, `tgl_kembali`) VALUES
(1, 1, 22, 'Kirim kepetugas ukur', '1', '2021-06-28 10:55:49', 'Dikirim', '-', NULL, NULL, 'Operator', NULL),
(2, 1, NULL, 'Dikembalikan ke oprator', '1', '2021-06-28 10:56:40', 'Dikembalikan', '-', NULL, NULL, 'Petugas Ukur', '2021-06-27'),
(3, 1, 22, 'Dikirim kembali ke petugas ukur', '1', '2021-06-28 10:57:20', 'Dikirim', '-', NULL, NULL, 'Operator', NULL),
(4, 1, 34, 'diterima petugas ukur dan akan dikirim ke petugas grafis', '1', '2021-06-28 10:58:11', 'Dikirim', '3 Days', '2021-06-25', '2021-06-28', 'Petugas Grafis', NULL),
(6, 1, NULL, 'dikembalikan ke petugas ukur', '1', '2021-06-28 11:01:44', 'Dikembalikan', '-', NULL, NULL, 'Petugas Grafis', '2021-06-28'),
(7, 1, 12, 'diterima petugas grafis dan dikirim ke petugas textual', '1', '2021-06-28 11:04:32', 'Dikirim', '1 Day', '2021-06-28', '2021-06-29', 'Petugas Grafis', NULL),
(8, 1, NULL, 'dikembalikan ke petugas ukur', '1', '2021-06-28 11:08:41', 'Dikembalikan', '-', NULL, NULL, 'Petugas Grafis', '2021-06-23'),
(9, 1, 31, 'dikirim ke petugas grafis', '1', '2021-06-28 11:09:12', 'Dikirim', '', '2021-06-23', '2021-06-23', 'Petugas Grafis', NULL),
(10, 1, 20, 'dikirim petugas textual', '1', '2021-06-28 11:10:03', 'Dikirim', '3 Days', '2021-06-23', '2021-06-26', 'Petugas Grafis', NULL),
(11, 1, NULL, 'dikembalikan ke petugas grafis', '1', '2021-06-28 11:15:29', 'Dikembalikan', '-', NULL, NULL, 'Petugas Grafis', '2021-06-23'),
(12, 1, 17, 'kirim ke petugas tektual', '1', '2021-06-28 11:16:07', 'Dikirim', '6 Days', '2021-06-23', '2021-06-29', 'Petugas Grafis', NULL),
(13, 1, 14, 'kirim ke kordinator pemetaan', '1', '2021-06-28 11:16:30', 'Dikirim', '2 Days', '2021-06-28', '2021-06-30', 'Petugas Textual', NULL);
