...
<html lang="en">
    ...
    <body class="login">
        ...
        <div class="logo">
            <a href="">
                <img src="assets/pages/img/atrbpn.png" alt="" width="150px"/> 
            </a>
        </div>
        <!-- END LOGO -->
        <!-- BEGIN LOGIN -->
        <div class="content">
            ...
            <form class="login-form" action="masuk.php" method="post">
                <h3 class="form-title font-blue">Silahkan Login!</h3>
                <?php
            ...
            <form class="forget-form" action="index.html" method="post">
                <h4 class="font-red">Silahkan hubungi Developer!</h4>
                <!--
				<div class="form-group">
        ...
        <div class="copyright"> 2020 © Seksi Infrastruktur Pertanahan Kota Bandung. </div>
        <!--[if lt IE 9]>
