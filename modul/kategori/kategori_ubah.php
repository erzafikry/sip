<?php
	if(isset($_POST['btnSave'])){
		...
		if(count($message)==0){	
			$qryUpdate=mysqli_query($koneksidb, "UPDATE ms_kategori SET nama_kategori='$txtKategori', 
														keterangan_kategori='$txtKeterangan',
														status_kategori='$cmbStatus'	
													WHERE id_kategori ='".$_POST['txtKode']."'") 
				   or die ("Gagal query update".mysqli_error());
			if($qryUpdate){
				$_SESSION['pesan'] = 'Data kategori service berhasil diperbaharui';
