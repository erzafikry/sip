<?php
	if(isset($_POST['btnSave'])){
		...
		if(count($message)==0){			
			$sqlSave="INSERT INTO ms_kota SET id_provinsi='$cmbProv', 
				  							nama_kota='$txtNama',
			...
			if($qrySave){
				$_SESSION['pesan'] = 'Data Kota berhasil ditambahkan';
...
<div class="portlet box grey-cascade">
	<div class="portlet-title">
		<div class="caption"><span class="caption-subject uppercase bold">Form Tambah Kota</span></div>
		<div class="tools">
		...
		<form action="<?php $_SERVER['PHP_SELF']; ?>" method="post" name="frmadd" class="form-horizontal">
			<div class="form-body">
				<div class="form-group">
					...
					<div class="col-lg-2">
						<select name="cmbProv" class="select2 form-control" data-placeholder="Pilih Provinsi">
